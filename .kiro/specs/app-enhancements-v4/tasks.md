...
- [x] 3. Fix attendance by service API parameter bug
...
- [x] 3.1 Write property test for service ID parameter inclusion
  - **Property 5: Service ID parameter inclusion**
  - **Validates: Requirements 3.1, 3.2, 3.3**

- [x] 3.2 Write property test for meaningful error messages
  - **Property 6: Meaningful error messages**
  - **Validates: Requirements 3.4**

- [x] 4. Create public forms page infrastructure
...
- [x] 4.1 Write property test for public route accessibility
  - **Property 7: Public route accessibility**
  - **Validates: Requirements 4.2, 5.2**

- [x] 4.2 Write property test for Airtable form rendering
  - **Property 8: Airtable form rendering**
  - **Validates: Requirements 4.3**

- [x] 5. Create public contacts page infrastructure
...
- [x] 5.1 Write property test for Airtable interface embedding
...
- [x] 7. Configure Airtable embed URLs
