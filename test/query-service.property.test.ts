  ...
  describe('getServiceAttendees', () => {
    it('should return members who attended a service', async () => {
      ...
      const memberRecords: AirtableRecord[] = [
        { id: 'recMember001', fields: { 'First Name': 'John', 'Last Name': 'Doe', 'Full Name': 'John Doe', 'Old Phone': '123', 'Status': 'Member', 'Source': 'Other', 'Date First Captured': '2024-01-01', 'Follow-up Status': 'Not Started' }, createdTime: new Date().toISOString() },
        { id: 'recMember002', fields: { 'First Name': 'Jane', 'Last Name': 'Doe', 'Full Name': 'Jane Doe', 'Old Phone': '456', 'Status': 'Member', 'Source': 'Other', 'Date First Captured': '2024-01-01', 'Follow-up Status': 'Not Started' }, createdTime: new Date().toISOString() },
      ];
  ...
  describe('getSoulsAssignedByFollowUpMember', () => {
    it('should return souls grouped by follow-up member', async () => {
      ...
      const memberRecords: AirtableRecord[] = [
        {
          id: 'recMember001',
          fields: { 'First Name': 'Soul', 'Last Name': 'Won', 'Full Name': 'Soul Won', 'Old Phone': '123', 'Status': 'Evangelism Contact', 'Source': 'Evangelism', 'Date First Captured': '2024-01-01', 'Follow-up Status': 'Not Started' },
          createdTime: new Date().toISOString(),
        },
      ];
